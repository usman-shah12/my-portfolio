...
class DemoData {
  static const List<ProjectModel> projects = [
    ...
    ProjectModel(
      ...
      description:
          'A productivity app with task organization, priority management, deadline reminders, and team collaboration features. Uses clean architecture with BLoC pattern for scalable state management.',
